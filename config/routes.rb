TWAmazon::Application.routes.draw do
  ...
  # auction messages paths
  #resources :auction_messages, :only =>[:show]
  #match 'silent_auctions/:id/auction_messages' => 'silent_auctions#auction_messages', :as => 'auction_messages'
  #match 'show', :to => 'AuctionMessages#Show', :as => :show, :via => :get
